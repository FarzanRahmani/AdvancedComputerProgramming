...
namespace P8.Server.Controllers
{
    ...
    public class ClotheController : Controller
    {
        ...
        [HttpGet("getClothByIdFromDb/{id}")] // api/Clothe/getClothByIdFromDb/2  id = Parameter
        ...
        public product UpdateProductInDb(product newProduct) // parameter az body darkhast too postman dade mishe 
        {

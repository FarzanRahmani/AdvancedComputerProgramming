...
namespace L3.Tests
{
    ...
    public class AppAnalysisTests
    {
        ...
        // TODO count apps which their rate above minRate
        [TestMethod()]
        ...
        {
            var result = Instance.ExtremeMeanUpdateElapse();

            Assert.AreEqual("40F71CE559D3F33A58B3305BA9780261", CalcMD5(result.Item1));
  
			Assert.AreEqual("F85D08F4609CB9F5D750707713CDF335", CalcMD5(result.Item2));
        }
